...
{
  "$end", "error", "$undefined", "NOTOKEN", "GREAT", "NEWLINE", "WORD",
  "GREATGREAT", "PIPE", "AMPERSAND", "LESS", "GREATAMPERSAND",
  "GREATGREATAMPERSAND", "$accept", "goal", "arg_list", "cmd_and_args",
  "$@1", "pipe_list", "io_modifier", "io_modifier_list",
  "background_optional", "command_line", "command_list", "$@2", YY_NULLPTR
};
#endif
...
{
      -2,     1,     2,    -2,    -1,     9,    -2,    -2,    -2,     5,
      -2,    -2,    -2,    10,     8,    15,    -2,    16,    17,    -2,
      18,    19,    20,    -2,    22,    -2,    -2,    -2,    -2,    -2,
      -2,    -2
};
...
{
      24,     0,    22,     1,     0,     0,    20,     6,     9,    16,
      23,    21,     3,     5,    18,     7,     8,     0,     0,    17,
       0,     0,     0,    15,     0,     4,    11,    10,    14,    13,
      12,    19
};
...
{
       5,     3,    -2,    -5,     6,     7,    -5,    -5,    -5,    -5,
      -5,    -5,    17,    13,    11,    18,     7,    19,    20,    21,
      22,    25,    26,    27,    28,    29,    30,    31,     0,     0,
       0,     0,     0,     0,    16
};
...
static const yytype_int8 yycheck[] =
{
      ...
      11,    12,     4,     8,     5,     7,     6,     9,    10,    11,
      12,     6,     6,     6,     6,     6,     6,     5,    -1,    -1,
      -1,    -1,    -1,    -1,    13
};
...
{
       0,    14,    23,     0,    24,     1,     5,     6,    16,    18,
      22,     5,    17,     8,    20,    15,    16,     4,     7,     9,
      10,    11,    12,    19,    21,     6,     6,     6,     6,     6,
       6,     5
};
